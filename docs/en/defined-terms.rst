...
.. glossary::
    ...
    **Selection Page**
      It's the page of the Touchpoint of the Relying Party where the User can see all the Wallet Solutions available in the Registry and is able to select which one to continue the process of Authentication with.
